#ifndef STAT_MTRX_LIB_W_V2_H
#define STAT_MTRX_LIB_W_V2_H
...
void generate_matrix_into_file(const std::string& filename, size_t rows, size_t cols);
matrix read_matrix_from_file(const std::string& filename, size_t rows, size_t cols);
