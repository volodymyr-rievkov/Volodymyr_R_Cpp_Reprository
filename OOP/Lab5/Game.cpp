...
void Game::set_battlefield()
{
    ...
    do
    {
        ...
        if(choice < 1 || choice > 2)
        {
            ...
            std::cerr << "Error: Number is out of range." << std::endl << std::endl;
            Character::change_font_colour(7);
        }
...
void Game::set_players_amount()
{
    ...
    do
    {
        std::cerr << "Enter amount of players(" << players_amount_limits.first << "-" << players_amount_limits.second << "): ";
        std::cin >> *players_amount;
        if(*players_amount < players_amount_limits.first || *players_amount > players_amount_limits.second)
        {
            Character::change_font_colour(4);
            std::cerr << "Error: Amount of players is out of range." << std::endl << std::endl;
            Character::change_font_colour(7);
        }
...
void Game::set_players()
{
    ...
    for(int i = 0; i < *players_amount; i++)
    {
        ...
        do
        {
            ...
            {
                Character::change_font_colour(4);
                std::cerr << "Error: Name is already used." << std::endl << std::endl;
                Character::change_font_colour(7);
            }
